...
with tf.Session() as sess:
    ...
    np.savetxt('test_set/baseline_6_clus_'+str(cluster)+'_label.csv',testset_y,fmt='%d')
    np.savetxt('test_set/baseline_6_clus_'+str(cluster)+'_predict.csv',result_reversefit,fmt='%d')
    ...
    for i in cluster_file:
        ...
        counter += 1
    np.savetxt('submission/baseline_6_clus_' + str(cluster) + '_predict.csv', result_reversefit, fmt='%d')
